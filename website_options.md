...
Final verdict: The United Methodist Web Hosting templates that I felt have the most promise are two very popular and similar looking WordPress templates called [Twenty Eleven](https://wordpress.org/themes/twentyeleven) and Catching Everest. As noted in Other Area Churches, nearby New Jerusalem Church is already using the [Twenty Eleven](https://wordpress.org/themes/twentyeleven) theme. I decided to forgo this in order to have something unique to Pretty Prairie United Methodist Church. 
...
To check out more of the design process, go to [Research and Design Sprint](design_sprint.md). <br>
